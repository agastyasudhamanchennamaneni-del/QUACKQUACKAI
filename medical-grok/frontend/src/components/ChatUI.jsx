...
const ChatUI = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("https://quackquackai.onrender.com/api/ask", {
        method: "POST",
      ...
      const aiMessage = {
        sender: "bot",
        text: data.reply || "⚠️ Sorry, I couldn’t find that info.",
      };
  ...
  return (
    <div className="chat-container">
      ...
      <div className="input-area">
        <input
          type="text"
          placeholder="Ask me about symptoms, nutrition, or health..."
          value={input}
